...
行数：2786 → 2774 → 2763 → 2755 → 2751 → 2747 → 2742 → 2737 → 2731 → 2727 → 2721 → 2701 → 2682 → 2682 → 2680 → 2680 → 2678 → 2677（第十四批只搬引用、净行数不变；第十五批 3 个开关收成 1 行声明 + 1 行接线，净 −2；第十六批 2 个引用状态收进持有类、净 0；第十七批聊天锁错误文案归位、净 −2；第十八批禁言到期触发器收进持有类、`mutableLongStateOf` import 一并移除、净 −1，热点上限保持 2677；每批都同步收紧热点上限，零余量规则）。
