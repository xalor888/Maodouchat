...
- [~] 拆分 DATA、EVENT、RECEIPT、GROUP_CONTROL projector（RECEIPT 已拆出 `MessageReceiptProjector`；GROUP_CONTROL 在 `GroupMessagingCoordinator`；DATA/EVENT 仍在 `MessagingV2TimelineProjector` 待继续拆）。
