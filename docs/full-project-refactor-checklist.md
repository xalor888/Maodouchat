...
- [~] 拆分 Message、Call、Social、Reminder notification service（1/4 完成：`ReminderNotificationService` 承接 AI 任务提醒 show/summary/3 cancel，`AppNotifier` 保留同签名薄委托 1057→944 行；共享渠道/门禁/post 能力暂为 `AppNotifier.internal`，随后续拆分下沉）。
