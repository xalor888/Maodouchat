...
| 事实 | 实测值 | 来源 |
|------|--------|------|
| 已跟踪文件 | 1800 | `git ls-files \| wc -l`
| 服务端测试文件 / 用例 | 119 个 / **479 绿** | `find server/src/test -name '*.kt'`；`server/build/test-results/test/*.xml` 汇总
...
| 自审清单体量 | 959,382 字节 | `wc -c docs/full-project-refactor-checklist.md`
