...
| 服务端测试文件 / 用例 | 118 个 / **466 绿** | `find server/src/test -name '*.kt'`；`server/build/test-results/test/*.xml` 汇总
...
| 自审清单体量 | 868,812 字节 | `wc -c docs/full-project-refactor-checklist.md`
