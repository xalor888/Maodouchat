...
| 服务端测试文件 / 用例 | 119 个 / **504 绿** | `find server/src/test -name '*.kt'`；`server/build/test-results/test/*.xml` 汇总
...
| 自审清单体量 | 967,348 字节 | `wc -c docs/full-project-refactor-checklist.md`
