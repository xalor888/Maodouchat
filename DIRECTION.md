...
| 服务端测试文件 / 用例 | 120 个 / **550 绿** | `find server/src/test -name '*.kt'`；`server/build/test-results/test/*.xml` 汇总
...
| 自审清单体量 | 975,794 字节 | `wc -c docs/full-project-refactor-checklist.md`
