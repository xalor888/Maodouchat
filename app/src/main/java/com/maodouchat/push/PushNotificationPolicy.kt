...
/**
 * Pure gates for whether a wake payload (WebSocket / backlog) should surface a local notification.
...
object PushNotificationPolicy {
    ...
    /**
     * Drop wakes addressed to another account after logout/account switch.
    ...
    /** 托盘 extras 用的会话 id：空白视为无效，避免点进错误会话。 */
