...
public val Icons.Outlined.Checklist: ImageVector
    get() {
        ...
        _checklist = materialIcon(name = "Outlined.Checklist") {
            materialPath {
                moveTo(22.0f, 7.0f)
                horizontalLineToRelative(-9.0f)
                verticalLineToRelative(2.0f)
...
public val Icons.Outlined.ChecklistRtl: ImageVector
    get() {
        ...
        _checklistRtl = materialIcon(name = "Outlined.ChecklistRtl") {
            materialPath {
                moveTo(11.0f, 7.0f)
...
public val Icons.Outlined.Fingerprint: ImageVector
    get() {
        ...
        _fingerprint = materialIcon(name = "Outlined.Fingerprint") {
            materialPath {
                moveTo(17.81f, 4.47f)
...
public val Icons.Outlined.GifBox: ImageVector
    get() {
        ...
        _gifBox = materialIcon(name = "Outlined.GifBox") {
            materialPath {
                moveTo(19.0f, 19.0f)
                horizontalLineTo(5.0f)
                verticalLineTo(5.0f)
...
public val Icons.Outlined.MarkChatUnread: ImageVector
    get() {
        ...
        _markChatUnread = materialIcon(name = "Outlined.MarkChatUnread") {
            materialPath {
                moveTo(22.0f, 6.98f)
...
public val Icons.Outlined.NearMe: ImageVector
    get() {
        ...
        _nearMe = materialIcon(name = "Outlined.NearMe") {
            materialPath {
                moveTo(17.27f, 6.73f)
...
public val Icons.Outlined.PrivacyTip: ImageVector
    get() {
        ...
        _privacyTip = materialIcon(name = "Outlined.PrivacyTip") {
            materialPath {
                moveTo(12.0f, 3.19f)
...
public val Icons.Outlined.SearchOff: ImageVector
    get() {
        ...
        _searchOff = materialIcon(name = "Outlined.SearchOff") {
            materialPath {
                moveTo(15.5f, 14.0f)
...
public val Icons.Outlined.SignalCellular4Bar: ImageVector
    get() {
        ...
        _signalCellular4Bar = materialIcon(name = "Outlined.SignalCellular4Bar") {
            materialPath {
                moveTo(2.0f, 22.0f)
...
public val Icons.Outlined.SignalCellularAlt: ImageVector
    get() {
        ...
        _signalCellularAlt = materialIcon(name = "Outlined.SignalCellularAlt") {
            materialPath {
                moveTo(17.0f, 4.0f)
                horizontalLineToRelative(3.0f)
                verticalLineToRelative(16.0f)
...
public val Icons.Outlined.Security: ImageVector
    get() {
        ...
        _security = materialIcon(name = "Outlined.Security") {
            materialPath {
                moveTo(12.0f, 1.0f)
                lineTo(3.0f, 5.0f)
                verticalLineToRelative(6.0f)
...
public val Icons.Outlined.SentimentSatisfied: ImageVector
    get() {
        ...
        _sentimentSatisfied = materialIcon(name = "Outlined.SentimentSatisfied") {
            materialPath {
                moveTo(15.5f, 9.5f)
